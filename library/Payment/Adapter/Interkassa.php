...
class Payment_Adapter_Interkassa extends Payment_AdapterAbstract implements \Fuse\InjectionAwareInterface
{
    /**
     * @var Fuse_Di
     */
	...
	*/
    ...
    public function processTransaction($api_admin, $id, $data, $gateway_id)
    {
        ...
        if ($ipn['ik_inv_st'] == 'success') {
            $invoiceModel = $this->di['db']->load('Invoice', $data['get']['bf_invoice_id']);
