...
class Payment_Adapter_PayPalEmail implements \Fuse\InjectionAwareInterface
{
    ...
    public function processTransaction($api_admin, $id, $data, $gateway_id)
    {
        ...
        if(!$tx['invoice_id']) {
            $api_admin->invoice_transaction_update(array('id'=>$id, 'invoice_id'=>$data['get']['bf_invoice_id']));
        }
        ...
        $invoice = $api_admin->invoice_get(array('id'=>$data['get']['bf_invoice_id']));
