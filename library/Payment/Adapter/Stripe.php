...
class Payment_Adapter_Stripe implements \Fuse\InjectionAwareInterface
{
    ...
    public function processTransaction($api_admin, $id, $data, $gateway_id)
    {
        ...
        $invoice = $this->di['db']->getExistingModelById('Invoice', $data['get']['bf_invoice_id']);
                ...
                <div class="loading" style="display:none;"><span>{% trans \'Loading ...\' %}</span></div>
                 <script src="https://checkout.stripe.com/checkout.js"></script>
                  ...
                  <script>
                    ...
                    document.addEventListener("bf_ajax_post_message_error", function(e) {
                        openHandler();
                    });
