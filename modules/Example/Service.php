...
class Service
{
    ...
    public function install()
    {
        ...
        //throw new \Fuse_Exception("Throw exception to terminate module installation process with a message", array(), 123);
        return true;
    }
    ...
    {
        //throw new \Fuse_Exception("Throw exception to terminate module uninstallation process with a message", array(), 124);
        return true;
    }
    ...
    {
        //throw new \Fuse_Exception("Throw exception to terminate module update process with a message", array(), 125);
        return true;
    }
    ...
    /**
     * Example event hook. Any module can hook to any BillingFuse event and perform actions
     *
     * Make sure extension is enabled before testing this event.
     *
     * NOTE: IF you have BF_DEBUG mode set to TRUE then all events with params
     ...
     * @throws  \Fuse_Exception
     */
    public static function onEventClientLoginFailed(\Fuse_Event $event)
    {
        ...
        // Use RedBean ORM in any place of BillingFuse where API call is not enough
        ...
        if($meta->meta_value > 30) {
            throw new \Fuse_Exception('You have failed to login too many times. Contact support.');
        }
    }
     ...
     * @param \Fuse_Event $event
     */
    public static function onBeforeGuestPublicTicketOpen(\Fuse_Event $event)
    {
     ...
     * @param \Fuse_Event $event
     */
    public static function onAfterClientOrderCreate(\Fuse_Event $event)
    {
        /* Uncomment lines below in order to see this function in action */
