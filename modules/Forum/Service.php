...
class Service implements InjectionAwareInterface
{
    ...
    public static function onAfterClientCreateForumTopic(\Fuse_Event $event)
    {
        $params = $event->getParameters();
        $id = $params['id'];
    }
    
    public static function onAfterAdminRepliedInForum(\Fuse_Event $event)
    {
        $di = $event->getDi();
        $api = $di['api_admin'];
        $params = $event->getParameters();
