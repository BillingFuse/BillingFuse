...
namespace Fuse\Mod\Massmailer\Api;
    ...
    public function update($data)
    {
        ...
        if(isset($data['from_name'])) {
            if(empty($data['from_name'])) {
                throw new \Fuse_Exception('Message from name can not be empty');
            }
...
{% endfilter %}
    ...
    public function send_test($data)
    {
        ...
        if(empty($model->content)) {
            throw new \Fuse_Exception('Add some content before sending message');
        }
