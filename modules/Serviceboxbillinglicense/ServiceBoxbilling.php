...
class ServiceBillingfuse implements \Fuse\InjectionAwareInterface
{
     ...
     * Api URL
     *
     * @example https://www.billingfuse.com/api
     * @var string
     */
    protected $_api_url = 'http://www.billingfuse.com/api';

    /**
     * Api key is found in BillingFuse profile page
     *
    ...
    /**
     * Same service can be used to control BillingFuse as client and guest
     *
     * @example guest
     * @example admin
     * @example client
    ...
    public function __construct($options)
    {
        ...
        $this->_cookie = sys_get_temp_dir() . '/bfcookie.txt';
    }
    ...
    public function __call($method, $arguments)
    {
        ...
        if (!is_array($json)) {
            throw new \Exception(sprintf('BillingFuse API: Invalid Response "%s"', $result));
        }
