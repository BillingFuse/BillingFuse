...
namespace Fuse\Mod\Servicecentovacast\Api;
...
class Admin extends \Api_Abstract
{
    ...
    private function _getService($data)
    {
        ...
        if(!$order) {
            throw new \Fuse_Exception('Centova Cast order not found');
        }
        ...
        if(!$s) {
            throw new \Fuse_Exception('Order :id is not activated', array(':id'=>$order->id));
        }
