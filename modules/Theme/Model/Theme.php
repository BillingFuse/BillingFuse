...
namespace Fuse\Mod\Theme\Model;
...
class Theme
{
    ...
    public function __construct($name)
    {
        ...
        if(!file_exists($this->getPath())) {
            throw new \Fuse_Exception('Theme ":name" does not exists', array(':name'=>$name));
        }
    }
    ...
    {
        return BF_URL . 'templates/'.$this->name;
    }

    public function getPath()
    {
        return BF_PATH_THEMES . DIRECTORY_SEPARATOR . $this->name;
    }
